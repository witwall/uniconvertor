...
def cms_create_transform(inputProfile, inMode,
					...
					renderingIntent=const.INTENT_PERCEPTUAL,
					flags=const.cmsFLAGS_NOTPRECALC):
	"""
...
def cms_create_proofing_transform(inputProfile, inMode,
							...
							proofingProfile,
							renderingIntent=const.INTENT_PERCEPTUAL,
							proofingIntent=const.INTENT_RELATIVE_COLORIMETRIC,
							flags=const.cmsFLAGS_SOFTPROOFING):
	"""
	Returns a handle to lcms transformation wrapped as a Python object.
